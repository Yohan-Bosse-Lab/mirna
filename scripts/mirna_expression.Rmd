...
output:
  html_document:
    number_sections: F
params:
  datapath: 'C:/Users/renseb01/Documents/Steinberg_Christian/miRNA/results/'
  outputpath: 'C:/Users/renseb01/Documents/Steinberg_Christian/miRNA/'
---
...
#
#rowm =rowMeans(mirna_expression1[,1:12])
mirna_expression1 = mirna_expression1[order(rowm,decreasing = T),]
...
#plots
plot(log(mirna_expression1[,12],10),log(mirna_expression[,12],10),xlab = 'log10 miRNA expression (9M reads)', ylab = 'log10 miRNA expression (4M reads)')
```
